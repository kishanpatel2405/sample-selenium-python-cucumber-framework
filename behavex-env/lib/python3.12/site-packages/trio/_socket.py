...
if TYPE_CHECKING:
    ...
    from typing_extensions import (Buffer, Concatenate, ParamSpec, Self,
                                   TypeAlias)
...
def _sniff_sockopts_for_fileno(
    ...
    from socket import (SO_DOMAIN,  # type: ignore[attr-defined,unused-ignore]
                        SO_PROTOCOL, SO_TYPE, SOL_SOCKET)
